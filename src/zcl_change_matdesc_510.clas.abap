CLASS zcl_change_matdesc_510 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_change_matdesc_510 IMPLEMENTATION.
...
*        WITH VALUE #( ( %key-Product = 'DUMMY_PRODUCT_510'
*                        %key-Language = 'E'
*                        ProductDescription = 'Dummy Product 510- Updated') )
*
*        REPORTED DATA(reported)
*        FAILED DATA(failed).
*
